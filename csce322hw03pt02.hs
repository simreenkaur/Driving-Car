...
main = do
 ...
 print "Result"
 printMap (oneVehicleManyTurns map turns)

-- YOUR CODE SHOULD COME AFTER THIS POINT
oneVehicleManyTurns :: [[Char]] -> [Char] -> [[Char]]
oneVehicleManyTurns map (head_4 : tail_4)
              | ( ((head_4 == 'n') && (north_north == 0)) && (empty_row tail_4 == False) ) = (oneVehicleManyTurns map tail_4)
              | ( ((head_4 == 's') && (south_south == 0)) && (empty_row tail_4 == False) ) = (oneVehicleManyTurns map tail_4)
              | ( ((head_4 == 'w') && (west_west == 0)) && (empty_row tail_4 == False) ) = (oneVehicleManyTurns map tail_4)
              | ( ((head_4 == 'e') && (east_east == 0)) && (empty_row tail_4 == False) ) = (oneVehicleManyTurns map tail_4)
              | ( ((head_4 == 'n') && (north_north == 1)) && (empty_row tail_4 == True) ) = (oneVehicleOneTurn_helper map head_4 '1')
              | ( ((head_4 == 's') && (south_south == 1)) && (empty_row tail_4 == True) ) = (oneVehicleOneTurn_helper map head_4 '1')
              | ( ((head_4 == 'w') && (west_west == 1)) && (empty_row tail_4 == True) ) = (oneVehicleOneTurn_helper map head_4 '1')
              | ( ((head_4 == 'e') && (east_east == 1)) && (empty_row tail_4 == True) ) = (oneVehicleOneTurn_helper map head_4 '1')
              | ( ((head_4 == 'n') && (north_north == 0)) && (empty_row tail_4 == True) ) = map
              | ( ((head_4 == 's') && (south_south == 0)) && (empty_row tail_4 == True) ) = map
              | ( ((head_4 == 'w') && (west_west == 0)) && (empty_row tail_4 == True) ) = map
              | ( ((head_4 == 'e') && (east_east == 0)) && (empty_row tail_4 == True) ) = map
              | otherwise = oneVehicleManyTurns changed_map tail_4
              where north_north = continue_boolean map (i-1, j)
                    ...
                    (i,j) = head_3
                    (head_3 : tail_3) = find_vehicle_2D map '1'
                    changed_map = oneVehicleOneTurn_helper map head_4 '1'
...
oneVehicleOneTurn_helper map turn vehicle
        ...
        where 
          ...
          position  = head_1
          (head_1 : tail_1) = find_vehicle_2D map '1'
...
possible_moves map position 
        ...
        where north_position = (i - 1, j)
              ...
              east_position = (i , j + 1)
              (i,j) = head
              (head : tail) = find_vehicle_2D map '1'
              rows = total_rows map
